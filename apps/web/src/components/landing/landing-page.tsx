        ...
        <div className="space-y-8">
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <p className="max-w-2xl text-lg leading-8 text-[var(--color-text-secondary)] sm:text-xl">
              CollabSphere brings workspaces, documents, tasks, and team activity
              into one product surface so planning, writing, and execution do not
              fracture into separate tools.
            </p>
          </div>
