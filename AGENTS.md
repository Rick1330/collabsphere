...
## Repo Identity
CollabSphere is a realtime collaboration workspace platform built with a static web bootstrap/client (`apps/web`), NestJS (API), Hocuspocus (collab), BullMQ (workers), and PostgreSQL + Redis.
