...
## Purpose
Implement a Next.js page aligned with CollabSphere routing, state, and accessibility rules.

## When to Use
- Creating or modifying a page, layout, or route under `apps/web`.
...
- Prefer task labels like `spec:nextjs-page` or `spec:data-hooks` instead of generic `spec:ui`.
